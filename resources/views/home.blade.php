...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header" id="home">
        <div class="container">
            <div class="infos">
                ...
                <h6 class="title">Muhammad Faidz</h6>
                <p>UI/UX Designer</p>
    ...
    <footer class="page-footer">
        <center><p>Copyright <script>document.write(new Date().getFullYear())</script> &copy; <a href="http://www.devcrud.com" target="_blank">DevCRUD</a></p></center>
    </footer> 
    <!-- End of page footer -->
